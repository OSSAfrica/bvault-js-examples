...
export const TasksView: React.FC = () => {
  ...
  const canManageTasks = hasPermission(currentUser, 'canManageTasks');
  const canViewAllTasks = hasPermission(currentUser, 'canViewAllTasks');
  const canDeleteTasks = hasPermission(currentUser, 'canDeleteTasks');
  ...
  const handleAddTask = async (taskData: Omit<Task, 'id' | 'createdAt' | 'createdBy'>) => {
    ...
    try {
      ...
      loadTasks(); // Reload to apply filters
