...
export const DashboardView: React.FC = () => {
  ...
  useEffect(() => {
    const checkPermissions = async () => {
      const viewAllTasks = await hasPermission(user, 'canViewAllTasks');
      const viewAllUsers = await hasPermission(user, 'canViewAllUsers');
      setCanViewAllTasks(viewAllTasks);
      setCanViewAllUsers(viewAllUsers);
    };
